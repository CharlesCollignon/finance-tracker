          ...
          {card.lead ? (
            <View className="shrink items-end gap-0.5">
              {/* Label above, figure below: a figure read before its label is
                  ...
                  family it is, and the figure is still there; the screen
                  reader still hears the label, since the header's
                  `accessibilityLabel` is built from `card.lead` and not from
                  what is drawn. */}
