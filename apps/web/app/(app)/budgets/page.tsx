          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {[
              ...
              <Link
                key={href}
                href={href}
                className="flex items-center justify-between gap-3 rounded-card border border-border bg-card px-4 py-3 text-sm transition-colors hover:border-hairline-strong"
              >
                <span>
