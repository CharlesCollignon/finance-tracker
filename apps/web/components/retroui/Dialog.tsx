...
const dialogVariants = cva(
  `fixed left-[50%] top-[50%] z-50 grid rounded-control overflow-hidden w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-border bg-card duration-hover
 data-[open]:animate-in
 data-[open]:fade-in-0
